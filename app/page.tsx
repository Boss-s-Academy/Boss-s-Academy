  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#0b131c] dark:text-white mb-4">Our Mission</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-[#0b131c] mb-4">Quality Resources</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-[#0b131c] mb-4">Innovative Learning</h3>
              <p className="text-[#a6a6a6]">
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-[#0b131c] mb-4">Success Focused</h3>
              <p className="text-[#a6a6a6]">
      ...
      <section className="py-16 bg-white dark:bg-gray-800">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold dark:text-white text-[#0b131c] mb-4">Featured Resources</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              <div className="h-48 bg-cover bg-center" style={{ backgroundImage: `url('/images/igcse.jpg')` }}></div>
              <div className="p-6">
                <h3 className="text-xl font-semibold dark:text-white text-[#0b131c] mb-2">IGCSE Resources</h3>
            ...
            <div className="bg-gray-50 rounded-lg  dark:bg-gray-900 overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              <div className="h-48 bg-cover bg-center" style={{ backgroundImage: `url('/images/alevel.jpg')` }}></div>
              <div className="p-6">
                <h3 className="text-xl font-semibold dark:text-white text-[#0b131c] mb-2">A-Level Materials</h3>
                <p className="text-[#a6a6a6] mb-4">
            ...
            <div className="bg-gray-50 rounded-lg dark:bg-gray-900 overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold dark:text-white text-[#0b131c] mb-2">IB Support</h3>
                <p className="text-[#a6a6a6] mb-4">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl dark:text-white font-semibold text-[#0b131c] mb-2">Pearson Resources - Upcoming</h3>
                <p className="text-[#a6a6a6] mb-4">
            ...
            <div className="bg-gray-50 rounded-lg dark:bg-gray-800 overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              <div className="h-48 bg-cover bg-center" style={{ backgroundImage: `url('/images/olevel.jpg')` }}></div>
              <div className="p-6">
                <h3 className="text-xl dark:text-white font-semibold text-[#0b131c] mb-2">Cambridge O Level Resources - Upcoming</h3>
                <p className="text-[#a6a6a6] mb-4">
            ...
            <div className="bg-gray-50 rounded-lg dark:bg-gray-800 overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl dark:text-white font-semibold text-[#0b131c] mb-2">Other more to come</h3>
                <p className="text-[#a6a6a6] mb-4">
